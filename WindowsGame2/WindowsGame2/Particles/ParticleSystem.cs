...
namespace BibbleGame
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public float Size { get { return size; } set {
            float factor = value / size;
            minScale *= factor;
            maxScale *= factor;
            minInitialSpeed *= factor;
            maxInitialSpeed *= factor;
            minAcceleration *= factor;
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                BibbleGame.Random.Next(minNumParticles, maxNumParticles);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // initializeConstants
            game.SpriteBatchEffects.Begin(SpriteSortMode.Deferred, blendState);
            ...
            foreach (Particle p in particles)
            {
                ...
                game.SpriteBatchEffects.Draw(texture, p.Position, null, color,
                    p.Rotation, origin, scale, SpriteEffects.None, 0.0f);
            }

            game.SpriteBatchEffects.End();
        ...
        {
            return min + (float)BibbleGame.Random.NextDouble() * (max - min);
        }
    }
}
